...
def display_product_card(product, col_index, project, visibility_settings):
    ...
    for i, field in enumerate(all_fields):
        with cols[i % num_cols]:
            ...
            visibility = st.checkbox(
                ...
                key=f"vis_{field}_{project_id}_{i}"
            )
            ...
            with col_asc:
                ...
                if st.button(
                    ...
                    key=f"sort_asc_{field}_{project_id}_{i}",
            ...
            with col_desc:
                ...
                if st.button(
                    ...
                    key=f"sort_desc_{field}_{project_id}_{i}",
